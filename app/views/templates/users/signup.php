<section class="main">
    ...
    <p>
        <label for="name" class="form__text-label">Name:</label>
        <input type="text" name="authors[name]" value="<?php if(!!$_POST['authors']['name']): echo $_POST['authors']['name']; endif; ?>">
    </p>
    <p><?php echo Form::textfield('username'); ?></p>
    <p>
        <label for="name" class="form__text-label">Password:</label>
